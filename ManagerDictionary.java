...
public class ManagerDictionary {
 ...
 // Method to handle the "Lookup Employees" menu option
    public void runLookupEmployees() {
        Scanner scanner = new Scanner(System.in);
        ...
        switch (lookupChoice) {
            case "1":
                lookupEmployees("pre-order");
                break;
            case "2":
                lookupEmployees("in-order");
                break;
            case "3":
                lookupEmployees("post-order");
                break;
            default:
	...
	// search for employee 
    // Lookup employees in the dictionary
